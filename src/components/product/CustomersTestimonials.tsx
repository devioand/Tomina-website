        ...
        <div className="pt-4 md:pt-8 pb-4 md:pb-16 w-full">
          <div className="mx-auto max-w-[1037px] px-4 md:px-12 md:mb-12">
            <div className="flex flex-col justify-center items-center ">
              <h2 className="text-[#AA1D1D] text-24px lg:text-[64px] font-[800] mb-2">
                Testimonials
              </h2>
              <p className="text-[#BBAD87] text-[8px] lg:text-[24px] font-[800] lg:font-[700] mb-4">
                All in good taste elementum integer enim neque volutpat ac.
              </p>
              <p className="text-[#BBAD87] text-[12px] lg:text-[20px] font-[400] lg:font-[500] text-center">
