...
const Ratio = () => {
  return (
    <div className="max-w-full bg-[#282828]">
      <AnimateY>
        <div className="flex justify-between items-center px-5 md:px-32 py-12">
          <div className="flex justify-center items-center flex-col py-5 md:py-0">
            ...
            <div className="border py-2 px-5 md:py-4 md:px-7 rounded-[5rem] text-xl text-white">
              10
              <br />
              min
            </div>
          ...
          <div className="flex justify-center items-center flex-col py-5 md:py-0">
            ...
            <div className="border py-6 px-5 md:py-7 md:px-6 rounded-[5rem] text-xl text-white">
              8-10
            </div>
          </div>
        </div>
