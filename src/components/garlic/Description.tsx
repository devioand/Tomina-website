          ...
          <div className="md:backgroundColor grid lg:grid-cols-2 p-2 gap-y-4">
            <div className="p-8 backgroundColor">
              ...
              <ul className="">
                ...
                <li className="text-base list-disc text-white  ">
                  Place the salmon, skin side down, on a non-stick baking sheet
                  or in a non-stick pan with an oven-proof handle. Bake until
                  the salmon is cooked through, about 12 to 15 minutes.
                </li>
              </ul>
            </div>
            <div className="p-8  backgroundColor  mt-2 md:mt-0">
              ...
              <ul>
                ...
                <li className="text-base list-disc text-white">
                  2 Tbsp Spice World Squeezable Ginger or 2 Tbsp Ready-to-Use
                  Jar Ginger
                </li>
                <li className="text-base list-disc text-white">
